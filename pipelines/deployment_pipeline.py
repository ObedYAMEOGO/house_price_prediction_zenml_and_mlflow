...
from steps.dynamic_data_importer import dynamic_importer
...
def continuous_deployment_pipeline():
    ...
    # (Re)deploy the trained model to MLflow
    deployed_model = mlflow_model_deployer_step(
        workers=3, deploy_decision=True, model=trained_model
    )
...
def inference_pipeline():
    ...
    batch_data = dynamic_importer()  # This should now work correctly
